...
cl /nologo /LD /O2 /W4 /WX /DSAM_BUILD_DLL /I "%HERE%include" "%HERE%src\sam_render.c" /Fe:"%HERE%build\sam_render-%1.dll" /Fo:"%HERE%build\sam_render-%1.obj" /link /INCREMENTAL:NO || exit /b 1
endlocal
exit /b 0
